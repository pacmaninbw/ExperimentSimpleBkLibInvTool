...
-- Schema pacswlibinvtool
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pacswlibinvtool` DEFAULT CHARACTER SET UTF8MB4 ;
USE `pacswlibinvtool` ;

-- CREATE USER 'root'@'localhost' IDENTIFIED BY 'PaC1n+h3Am';
GRANT ALL ON pacswlibinvtool.* TO 'root'@'localhost';

-- CREATE USER 'pacsw'@'localhost' IDENTIFIED BY 'X5$1x#Eo0$t3';
GRANT ALL ON pacswlibinvtool.* TO 'pacsw'@'localhost';
